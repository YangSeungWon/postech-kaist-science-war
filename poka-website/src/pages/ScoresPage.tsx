...
const scoresData = [
  ...
  { category: '인공지능', postech: 3, kaist: 2, videoUrl: 'https://www.youtube.com/watch?v=t2_VMHkVQds', status: 'finished' },
  { category: '리그오브레전드', postech: 0, kaist: 0, videoUrl: 'https://www.youtube.com/watch?v=4BVrzDfgcVQ', status: 'upcoming' },
